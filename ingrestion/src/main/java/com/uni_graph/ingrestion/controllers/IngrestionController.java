...
public class IngrestionController {
  ...
  @Operation(
      ...
      description = "Upload a CSV file containing course data. Required columns (in order): \n" +
          "1. id (Integer)\n" +
  ...
  public ResponseEntity<String> ingestData(
      @Parameter(description = "CSV file to upload", content = @Content(mediaType = MediaType.MULTIPART_FORM_DATA_VALUE))
